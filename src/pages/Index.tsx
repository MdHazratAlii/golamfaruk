...
const Portfolio = () => {
  ...
  return (
    <div className="font-poppins bg-slate-50 text-gray-900 overflow-x-hidden">
      {/* Navigation */}
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-200">
            <div className="px-4 pt-2 pb-3 space-y-1">
              <button onClick={() => scrollToSection('home')} className="block px-3 py-2 text-gray-600 hover:text-blue-600">Home</button>
              <button onClick={() => scrollToSection('about')} className="block px-3 py-2 text-gray-600 hover:text-blue-600">About</button>
              <button onClick={() => scrollToSection('experience')} className="block px-3 py-2 text-gray-600 hover:text-blue-600">Experience</button>
              <button onClick={() => scrollToSection('services')} className="block px-3 py-2 text-gray-600 hover:text-blue-600">Services</button>
              <button onClick={() => scrollToSection('projects')} className="block px-3 py-2 text-gray-600 hover:text-blue-600">Projects</button>
              <button onClick={() => scrollToSection('contact')} className="block px-3 py-2 text-gray-600 hover:text-blue-600">Contact</button>
            </div>
          </div>
        )}
      </nav>
            ...
            <div className="space-y-8 animate-fade-in">
              <div className="space-y-4">
                <div className="inline-block bg-blue-100 px-4 py-2 rounded-full">
                  <span className="text-blue-600 font-semibold text-sm">SENIOR 3D MACHINERY DESIGNER</span>
                </div>
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-gray-900">
                  Hi, I'm <br />
                  <span className="text-blue-600">Golam Faruk</span>
                </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                <Button 
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 text-lg font-semibold rounded-lg shadow-lg transition-all duration-300"
                >
                  View My Work
                ...
                <Button 
                  ...
                  variant="outline" 
                  className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-6 text-lg font-semibold rounded-lg transition-all duration-300"
                >
                  Let's Connect
                </Button>
              </div>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-4 shadow-xl border border-gray-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-semibold text-gray-900">Available for Projects</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {[
              ...
              <Card key={index} className="text-center p-6 bg-white border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 animate-scale-up" style={{animationDelay: `${index * 0.1}s`}}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 animate-slide-in">
              <Card className="p-8 shadow-lg border border-gray-200 bg-white">
                <h3 className="text-2xl font-bold mb-6 text-gray-900">Quick Profile</h3>
                <div className="space-y-6">
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3">
                      <div className="text-gray-600">Age:</div>
                      <div className="font-semibold text-gray-900">52 years</div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <MapPin className="w-5 h-5 text-blue-600" />
                      <div className="font-semibold text-gray-900">Waterloo, Iowa, USA</div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Mail className="w-5 h-5 text-blue-600" />
                      <div className="font-semibold text-gray-900">hello@golamfaruk.com</div>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Phone className="w-5 h-5 text-blue-600" />
                      <div className="font-semibold text-gray-900">+1 022 444 05 05</div>
                    </div>
                  </div>
                ...
                <Button 
                  ...
                  className="w-full mt-6 bg-blue-600 hover:bg-blue-700 text-white py-3 font-semibold rounded-lg transition-all duration-300"
                >
            ...
            <div className="space-y-8 animate-slide-in-right">
              <h3 className="text-3xl font-bold mb-8 text-gray-900">Explore My Skillset</h3>
              
              {[
                { name: 'AutoCAD', level: 95, description: 'Precision technical drawings and 2D/3D modeling for complex machinery designs' },
                { name: 'SketchUp', level: 90, description: '3D modeling and architectural visualization with advanced rendering capabilities' },
                { name: 'Solid Edge', level: 85, description: 'Advanced CAD design and simulation for engineering solutions' },
                { name: 'Draft', level: 90, description: 'Technical documentation and blueprints with industry-standard precision' }
              ].map((skill, index) => (
